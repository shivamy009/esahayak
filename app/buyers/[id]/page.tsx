        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <Button
                  ...
                  className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white shadow-md px-4 sm:px-6"
                >
                  <Edit className="w-4 h-4 mr-2" />
                  <span className="hidden sm:inline">Edit Buyer</span>
                  <span className="sm:hidden">Edit</span>
                </Button>
                <Button
                  onClick={() => setShowDeleteModal(true)}
                  variant="outline"
                  className="border-red-300 text-red-600 hover:bg-red-50 hover:border-red-400 px-4 sm:px-6"
                >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-3 break-words">
                    {buyer.fullName}
                  </h1>
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    <Badge className={`${getStatusColor(buyer.status)} font-medium px-3 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm w-fit`}>
                      {buyer.status}
                    </Badge>
                    <span className="text-gray-500 text-xs sm:text-sm bg-gray-100 px-2 sm:px-3 py-1 rounded-full w-fit">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6">
            ...
            <Card className="xl:col-span-2 shadow-lg border-0 overflow-hidden">
              ...
              <CardContent className="p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-gray-50 to-blue-50">
                <div className="space-y-6">
                  {/* Phone Contact */}
                    <div className="group relative">
                      ...
                      <div className="relative bg-white p-4 sm:p-6 rounded-2xl shadow-md border border-blue-100 hover:shadow-xl hover:border-blue-200 transition-all duration-300 group-hover:transform group-hover:scale-105">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <p className="text-xs sm:text-sm text-gray-500 font-medium uppercase tracking-wide">Phone Number</p>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mt-1">
                              <p className="font-bold text-gray-900 text-lg sm:text-xl break-all">{buyer.phone}</p>
                              <Button
                                size="sm"
                                variant="ghost"
                                className="h-8 w-8 p-0 hover:bg-blue-100 self-start sm:self-auto flex-shrink-0"
                  ...
                  {buyer.email && (
                    <div className="group relative">
                      ...
                      <div className="relative bg-white p-4 sm:p-6 rounded-2xl shadow-md border border-green-100 hover:shadow-xl hover:border-green-200 transition-all duration-300 group-hover:transform group-hover:scale-105">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                          <div className="relative flex-shrink-0">
                            <div className="p-3 sm:p-4 bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl shadow-lg">
                              <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                            </div>
                            <div className="absolute -top-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 bg-orange-400 rounded-full border-2 border-white"></div>
                          </div>
                          <div className="flex-1 min-w-0">
                            <p className="text-xs sm:text-sm text-gray-500 font-medium uppercase tracking-wide">Email Address</p>
                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mt-1">
                              <p className="font-bold text-gray-900 text-sm sm:text-lg break-all">{buyer.email}</p>
                              <Button
                                size="sm"
                                variant="ghost"
                                className="h-8 w-8 p-0 hover:bg-green-100 flex-shrink-0 self-start sm:self-auto"
                ...
                {/* Quick Actions */}
                <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-gradient-to-r from-indigo-50 via-purple-50 to-pink-50 rounded-2xl border border-indigo-100">
            ...
            <Card className="shadow-md border-0">
              <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-t-lg">
                <CardTitle className="flex items-center gap-2 text-gray-800">
                  ...
                  <span className="text-sm sm:text-base">Status & Timeline</span>
                </CardTitle>
              </CardHeader>
            ...
            <Card className="shadow-md border-0">
              <CardHeader className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-t-lg">
                <CardTitle className="flex items-center gap-2 text-gray-800">
                  ...
                  <span className="text-sm sm:text-base">Property Requirements</span>
                </CardTitle>
              </CardHeader>
              <CardContent className="p-4 sm:p-6 space-y-4">
